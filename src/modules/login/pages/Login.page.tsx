                ...
                <div className="card sgp-bg-gray-30 text-white sgp-card">
                  <div className="card-body p-5 text-center">
                    <div className="mb-md-5 mt-md-4 pb-5">
                      <h2 className="fw-bold mb-2 sgp-lb--h1">{t("login.title")}</h2>
                      <p className="text-white-50 mb-5 sgp-text-white">{t("login.description")}</p>
                      <Formik
                      ...
                      >
                        {(formikProps) => (
                          <Form>
                            ...
                            <button className="btn sgp-btn sgp-btn--primary btn-lg px-5" type="submit" disabled={!formikProps.isValid}>{t("login.goIn")}</button>
                    ...
                    <div>
                      <p className="mb-0">{t("login.withoutAccount")} <Link to="enrollment" className="text-white-50 fw-bold sgp-text-orange-95">  {t("login.register")} </Link></p>
                    </div>
                  </div>
                </div>
              </div>
